  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        ...
        strokeLinecap="round"
      />
      <path d="m8.3 13.7 9-6.7-6.6 8.2" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" />
    </svg>
  )
}
...
export function MirIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 40 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="0.5" y="0.5" width="39" height="15" rx="2" stroke="currentColor" />
      <text
        x="20"
        y="11"
        textAnchor="middle"
...
export function CdekIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 60 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="0.5" y="0.5" width="59" height="19" rx="2" stroke="currentColor" />
      <text
        x="30"
        y="14"
        textAnchor="middle"
...
export function BoxberryIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 70 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="0.5" y="0.5" width="69" height="19" rx="2" stroke="currentColor" />
      <text
        x="35"
        y="14"
        textAnchor="middle"
...
export function PochtaIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 90 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="0.5" y="0.5" width="89" height="19" rx="2" stroke="currentColor" />
      <text
        x="45"
        y="14"
        textAnchor="middle"
...
export function SberIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 50 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="0.5" y="0.5" width="49" height="19" rx="2" stroke="currentColor" />
      <text
        x="25"
        y="14"
        textAnchor="middle"
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M6.5 20.5C9 16 13 12 18 8" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  )
}
...
export function TruckIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M3 7h11v9H3zM14 11h5l2 3v2h-7z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" />
...
export function PercentIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="m6 18 12-12" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  )
}
...
export function CardIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="3" y="6" width="18" height="13" rx="2" stroke="currentColor" strokeWidth="1.3" />
      <path d="M3 10h18" stroke="currentColor" strokeWidth="1.3" />
      <path d="M7 15h4" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  )
}
...
export function ArrowRight(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M4 12h16m-6-6 6 6-6 6" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  )
}
